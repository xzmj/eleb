...
{{--提交表单--}}
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="post" action="{{route('activity.update',[$activity])}}" enctype="multipart/form-data">
                                    {{--错误提示--}}
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">活动名称</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" name="end_time" class="form-control" value="{{$activity->start_time}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">活动详情</label>
                                        <div class="col-sm-9">
                                            <!-- 编辑器容器 -->
