...
@section('contents')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{route('shop_category.update',[$shop_category])}}" enctype="multipart/form-data">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="status" class="form-control mb-3">
                                                ...
                                                <option value ="1 " @if($shop_category->status==1) selected  @endif>显示</option>
                                                <option value ="0 " @if($shop_category->status==0) selected  @endif>隐藏</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="fileInput" type="file" class="form-control-file" name="img">
                                        </div>
                                    </div>
