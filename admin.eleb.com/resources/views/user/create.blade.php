...
{{--分类--}}
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">商家账号名称</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">商家账号密码</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">商家账号邮箱</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="id" class="form-control mb-3">
                                                @foreach($shops as $ds)
                                                    <option value="{{$ds->id}}" >{{$ds->shop_name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
