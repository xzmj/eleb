...
@section('contents')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{route('admin.savepwd')}}" enctype="multipart/form-data">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" disabled="" placeholder="{{auth()->user()->email}}" class="form-control">
                                        </div>
                                    </div>
