...
{{--提交表单--}}
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="{{route('nav.update',[$nav])}}" enctype="multipart/form-data">
...
{{--分类--}}
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">导航名称</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">导航路由</label>
                                        <div class="col-sm-9">
                                    ...
                                    <label class="col-sm-3 form-control-label">上级菜单</label>
                                    <div class="col-sm-9">
                                        <select name="pid" class="form-control mb-3">
                                            <option value="0" >--顶级菜单</option>
                                            @foreach($navs as $n)
                                            <option value="{{$n->id}}"  @if($nav->pid==$n->id) selected @endif>{{$n->name}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-sm-9">
                                            <select name="permission_id" class="form-control mb-3">
